...
const Sidebar = () => {
  ...
  return (
    <div>
      ...
      <h3 className='my-4 text-3xl font-medium tracking-wider font-serif' >i<span className='text-green-dat'>
        ABS</span></h3>
        <p className='px-2 py-1 my-3 bg-gray-200 rounded-full'>Web Developer</p>
        <a className='px-2 py-1 my-3 bg-gray-200 rounded-full flex items-center justity-center ' href='ABUBAKAR.pdf'><GiTie className="w-6 h-6"/>Download Resume</a>
        {/* social icon */}
        ...
        {/* Adress */}
        <div className='my-4 py-5 bg-gray-200' style={{marginLeft:'-1rem',marginRight:'-1rem'}}>
